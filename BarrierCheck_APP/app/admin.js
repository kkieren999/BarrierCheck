...
function renderPendingUsers(users) {
  ...
  users.forEach(function (record) {
    ...
    approve.type = "button";
    approve.textContent = "Approve & Unlock 3 Free Inspections";
...
function approveUser(uid, currentLicence) {
  ...
  setAdminStatus("Approving user and unlocking 3 free inspections...", false);
  callFunction("approveUser", { uid: uid, licenceNumber: licence })
    ...
    .then(function () {
      setAdminStatus("User approved. 3 free inspections unlocked.", false);
